...
urlpatterns = [
    ...
    path('page_1/page_3_choice_help/', views.page_3_choice_help, name='page_3_choice_help.html'),
    path('page_1/page_3_choice_ask/', views.page_3_choice_ask, name='page_3_choice_ask.html'),
    path('page_1/page_3_choice_leave/', views.page_3_choice_leave, name='page_3_choice_leave.html'),
